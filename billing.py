...
class billClass:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | AYUSH SHAH")
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by AYUSH SHAH\nFor any Technical Issues Contact: +91 8799146289",font=("times new roman",10),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#---------------------- all functions ------------------------------
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ-Inventory
\t Phone No. +91 8799146289 , VADODARA-390023
{str("="*46)}
